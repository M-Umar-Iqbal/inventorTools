...
import { Collapse, Alert, Autocomplete, Switch, FormControlLabel } from "@mui/material";
...
export default function Products() {
    ...
    function validPriceCheck(e) {
        ...
        if (value <= 0) {
            document.getElementById("priceWarn").innerHTML = "* Price must be Greater Than 0";
        } else {
    ...
    function validQuantityCheck(e) {
        ...
        if (value <= 0) {
            document.getElementById("quantityWarn").innerHTML = "* Quantity must me greater than 0";
        } else {
            ...
            >
                ...
                <div style={{ margin: "10px", padding: "10px" }}>
                    <TextField
                        ...
                        id="price"
                    />
                    <div style={{ color: 'red', fontWeight: "bold", marginTop: "10px", fontSize: "10px" }} id="priceWarn" ></div>
                </div>
                <div style={{ margin: "10px", padding: "10px" }}>
                    ...
                    <TextField
                        ...
                        id="quantity"
                    />
                    <div style={{ color: 'red', fontWeight: "bold", marginTop: "10px", fontSize: "10px" }} id="quantityWarn" ></div>

                </div>
                <div style={{ marginLeft: "15px", padding: "10px", }}>
                    <FormControlLabel label="Want to Add Description?" control={<Switch checked={label} onChange={handleChange} defaultChecked size="small" name="checked" />} />
                </div>
                <div style={{ margin: "10px", padding: "10px", maxHeight: '200px', overflowY: 'auto' }}>
                    <TextField
                        rows={5}
                        multiline
                        type="number"
